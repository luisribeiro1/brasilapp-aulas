            ...
            <div className="card h-100">
              <div className="card-body">
                ...
                <p className="fw-bold mb-0">
                  {municipio[campo]}
                  {campo !== 'populacao_2022' && <span className="text-muted fw-normal small ms-1">({municipio[campo], municipio.populacao_2022}%)</span>}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="col-6 col-md-4 col-lg-3">
          <div className="card h-100">
            <div className="card-body d-flex align-items-center">
              <Coffee size={28} className="text-success me-3 flex-shrink-0" />
              <div>
                <p className="text-muted small mb-0">Nome do produto</p>
                <p className="fw-bold mb-0">999 <span className="text-muted fw-normal small">toneladas</span></p>
              </div>
            </div>
          </div>
        </div>
